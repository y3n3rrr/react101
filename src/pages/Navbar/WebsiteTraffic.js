...
<main style={{ paddingLeft: 0 }}>
  <div className="container-fluid">
    {/* Page title */}
    <h4 className="mt-4 mb-5 text-center">Website traffic dashboard </h4>
            ...
            <div className="col-md-6">
              <div className="d-flex flex-wrap">
                <div className="select-outline position-relative w-100">
                  <div className="select-wrapper mdb-select md-form md-outline">
                    ...
                    <input
                      ...
                      readOnly="true"
                      required="false"
                      data-activates="select-options-4ac5d147-6f68-4169-84fd-fc8580e42a02"
                      defaultValue=""
                      role="listbox"
                    ...
                    />
                    <ul
                      id="select-options-4ac5d147-6f68-4169-84fd-fc8580e42a02"
                      className="dropdown-content select-dropdown w-100 "
                      style={{ display: "none" }}
                    >
                      <li
                        className="  "
                        ...
                        aria-disabled="false"
                      >
                        <span className="filtrable "> Today </span>
                      </li>
                      <li
                        className="  "
                        role="option"
                        ...
                        aria-disabled="false"
                      >
                        <span className="filtrable "> Yesterday </span>
                      </li>
                      <li
                        className=" active "
                        role="option"
                        ...
                        aria-disabled="false"
                      >
                        <span className="filtrable "> Last 7 days </span>
                      </li>
                      <li
                        className="  "
                        role="option"
                        ...
                        aria-disabled="false"
                      >
                        <span className="filtrable "> Last 28 days </span>
                      </li>
                      <li
                        className="  "
                        role="option"
                        ...
                        aria-disabled="false"
                      >
                        <span className="filtrable "> Last 90 days </span>
                      </li>
                    </ul>
                    <select className="mdb-select md-form md-outline initialized">
                        ...
                        <div className="picker__box">
                          <div className="picker__header">
                            <div className="picker__date-display">
                              <div className="picker__weekday-display">
                                Fri,{" "}
                              </div>
                            ...
                            <select
                              className="picker__select--month"
                              aria-controls="date-picker-example_table"
                            ...
                            <button
                              className="picker__nav--prev btn btn-flat waves-effect waves-effect"
                              data-nav={-1}
                              role="button"
                              aria-controls="date-picker-example_table"
                            ...
                            <button
                              className="picker__nav--next btn btn-flat waves-effect waves-effect"
                              data-nav={1}
                              role="button"
                              aria-controls="date-picker-example_table"
                              title="Next month"
                          ...
                          <table
                            ...
                            id="date-picker-example_table"
                            role="grid"
                            aria-controls="date-picker-example"
                            aria-readonly="true"
                          >
                            <thead>
                              <tr>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1743973200000}
                                    role="gridcell"
                                    aria-label="7 April, 2025"
                                  >
                                    7
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744059600000}
                                    role="gridcell"
                                    aria-label="8 April, 2025"
                                  >
                                    8
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744146000000}
                                    role="gridcell"
                                    aria-label="9 April, 2025"
                                  >
                                    9
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744232400000}
                                    role="gridcell"
                                    aria-label="10 April, 2025"
                                  >
                                    10
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744318800000}
                                    role="gridcell"
                                    aria-label="11 April, 2025"
                                  >
                                    11
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744405200000}
                                    role="gridcell"
                                    aria-label="12 April, 2025"
                                  >
                                    12
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744491600000}
                                    role="gridcell"
                                    aria-label="13 April, 2025"
                                  >
                                    13
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744578000000}
                                    role="gridcell"
                                    aria-label="14 April, 2025"
                                  >
                                    14
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744664400000}
                                    role="gridcell"
                                    aria-label="15 April, 2025"
                                  >
                                    15
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744750800000}
                                    role="gridcell"
                                    aria-label="16 April, 2025"
                                  >
                                    16
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1744837200000}
                                    role="gridcell"
                                    aria-label="17 April, 2025"
                                  >
                                    17
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    ...
                                    data-pick={1744923600000}
                                    role="gridcell"
                                    aria-label="18 April, 2025"
                                ...
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745010000000}
                                    role="gridcell"
                                    aria-label="19 April, 2025"
                                  >
                                    19
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745096400000}
                                    role="gridcell"
                                    aria-label="20 April, 2025"
                                  >
                                    20
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745182800000}
                                    role="gridcell"
                                    aria-label="21 April, 2025"
                                  >
                                    21
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745269200000}
                                    role="gridcell"
                                    aria-label="22 April, 2025"
                                  >
                                    22
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745355600000}
                                    role="gridcell"
                                    aria-label="23 April, 2025"
                                  >
                                    23
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745442000000}
                                    role="gridcell"
                                    aria-label="24 April, 2025"
                                  >
                                    24
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745528400000}
                                    role="gridcell"
                                    aria-label="25 April, 2025"
                                  >
                                    25
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745614800000}
                                    role="gridcell"
                                    aria-label="26 April, 2025"
                                  >
                                    26
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745701200000}
                                    role="gridcell"
                                    aria-label="27 April, 2025"
                                  >
                                    27
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745787600000}
                                    role="gridcell"
                                    aria-label="28 April, 2025"
                                  >
                                    28
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745874000000}
                                    role="gridcell"
                                    aria-label="29 April, 2025"
                                  >
                                    29
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--infocus"
                                    data-pick={1745960400000}
                                    role="gridcell"
                                    aria-label="30 April, 2025"
                                  >
                                    30
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746046800000}
                                    role="gridcell"
                                    aria-label="1 May, 2025"
                                  >
                                    1
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746133200000}
                                    role="gridcell"
                                    aria-label="2 May, 2025"
                                  >
                                    2
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746219600000}
                                    role="gridcell"
                                    aria-label="3 May, 2025"
                                  >
                                    3
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746306000000}
                                    role="gridcell"
                                    aria-label="4 May, 2025"
                                  >
                                    4
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746392400000}
                                    role="gridcell"
                                    aria-label="5 May, 2025"
                                  >
                                    5
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746478800000}
                                    role="gridcell"
                                    aria-label="6 May, 2025"
                                  >
                                    6
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746565200000}
                                    role="gridcell"
                                    aria-label="7 May, 2025"
                                  >
                                    7
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746651600000}
                                    role="gridcell"
                                    aria-label="8 May, 2025"
                                  >
                                    8
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746738000000}
                                    role="gridcell"
                                    aria-label="9 May, 2025"
                                  >
                                    9
                                  </div>
                                </td>
                                <td role="presentation">
                                  <div
                                    className="picker__day picker__day--outfocus"
                                    data-pick={1746824400000}
                                    role="gridcell"
                                    aria-label="10 May, 2025"
                                  >
                                    10
                                  </div>
                                </td>
            ...
            <div className="card-body">
              ...
              <h5 className="font-weight-bold mb-0">
                ...
                <small className="text-success ml-2">
                  <i className="fas fa-arrow-up fa-sm pr-1" />
                  13,48%
                </small>
              </h5>
              <hr />
              ...
              <h5 className="font-weight-bold text-muted mb-0">11 467</h5>
            </div>
          </div>
          {/* Card */}
        </div>
        ...
        <div className="col-md-3 col-sm-12 mb-4">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <h5 className="font-weight-bold text-muted mb-0">38 454</h5>
            </div>
          </div>
          {/* Card */}
        </div>
            ...
            <div className="card-body">
              ...
              <h5 className="font-weight-bold mb-0">
                ...
                <small className="text-danger ml-2">
                  <i className="fas fa-arrow-down fa-sm pr-1" />
                  23,58%
                </small>
              </h5>
              <hr />
              ...
              <h5 className="font-weight-bold text-muted mb-0">00:05:20</h5>
            </div>
          </div>
          {/* Card */}
        </div>
        ...
        <div className="col-md-3 col-sm-12 mb-4">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <h5 className="font-weight-bold text-muted mb-0">24.35%</h5>
            </div>
          </div>
          {/* Card */}
        </div>
        ...
        <div className="col-md-8 mb-4">
          ...
          <div className="card ">
            <div className="card-header white">
              <ul className="nav md-pills pills-primary nav-justified">
              ...
              <div className="tab-content">
                ...
                >
                  ...
                  <canvas
                    ...
                    width={803}
                    height={401}
                    style={{ display: "block", height: 321, width: 643 }}
                ...
                {/*/.Panel */}
                {/*Panel */}
                <div className="tab-pane fade" id="panel-time" role="tabpanel">
                  <div
                    className="chartjs-size-monitor"
                    style={{
                      position: "absolute",
          ...
          <div className="card mb-4">
            <div className="card-body">
              ...
              <canvas
                ...
                height={246}
                width={370}
                style={{ display: "block", height: 197, width: 296 }}
                className="chartjs-render-monitor"
              />
            </div>
          </div>
          ...
          <div className="card">
            <div className="card-body">
              <div id="world-map" style={{ height: 300 }}>
                ...
                >
                  <svg width="296.1" height={300}>
                    <g transform="scale(0.329) translate(0, 235.57389629966593)">
                      <path
                  ...
                  <div className="vector-map-zoom-in-btn">+</div>
                  <div className="vector-map-zoom-out-btn">−</div>
                </div>
              </div>
            </div>
          </div>
